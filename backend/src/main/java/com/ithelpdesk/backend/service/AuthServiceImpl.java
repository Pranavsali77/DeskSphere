...
import com.ithelpdesk.backend.security.CustomUserDetails;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String forgotPassword(ForgotPasswordRequest request) {
        ...
        // Later you can send an email here
        return "Password reset request received for " + user.getEmail();
    }
